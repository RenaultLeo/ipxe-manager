...
const PAIRS_DE = [
  ...
  ["Content", "Inhalt"],
  [
    "iPXE menu label (empty = config 1, config 2, …)",
    "iPXE-Menübeschriftung (leer = Config 1, Config 2, …)",
  ],
  ...
  [
    "Empty = config-1, config-2, … — or e.g. prod-web, class-a",
    "Leer = config-1, config-2, … — oder z. B. prod-web, klasse-a",
  ],
...
const PAIRS_ES = [
  ...
  [
    "iPXE menu label (empty = config 1, config 2, …)",
    "Etiqueta del menú iPXE (vacío = config 1, config 2, …)",
  ],
  ...
  [
    "Empty = config-1, config-2, … — or e.g. prod-web, class-a",
    "Vacío = config-1, config-2, … — o ej. prod-web, clase-a",
  ],
...
const PAIRS_IT = [
  ...
  [
    "iPXE menu label (empty = config 1, config 2, …)",
    "Etichetta menu iPXE (vuoto = config 1, config 2, …)",
  ],
  ...
  [
    "Empty = config-1, config-2, … — or e.g. prod-web, class-a",
    "Vuoto = config-1, config-2, … — oppure es. prod-web, classe-a",
  ],
...
const PAIRS_PT = [
  ...
  [
    "iPXE menu label (empty = config 1, config 2, …)",
    "Etiqueta do menu iPXE (vazio = config 1, config 2, …)",
  ],
  ...
  [
    "Empty = config-1, config-2, … — or e.g. prod-web, class-a",
    "Vazio = config-1, config-2, … — ou ex. prod-web, turma-a",
  ],
