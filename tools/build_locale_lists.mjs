...
const PAIRS_DE = [
  ...
  ["ipxe-boot.cfg", "ipxe-boot.cfg"],
  ["iPXE modules (mboot)", "iPXE-Module (mboot)"],
  [
    "iPXE preload order — same list for UEFI and Legacy.",
    "iPXE-Vorladereihenfolge — dieselbe Liste für UEFI und Legacy.",
  ],
  [
...
const PAIRS_ES = [
  ...
  ["ipxe-boot.cfg", "ipxe-boot.cfg"],
  ["iPXE modules (mboot)", "Módulos iPXE (mboot)"],
  [
    "iPXE preload order — same list for UEFI and Legacy.",
    "Orden de precarga iPXE — la misma lista para UEFI y Legacy.",
  ],
  [
    "Parameters passed to the kernel at boot",
...
const PAIRS_IT = [
  ...
  ["ipxe-boot.cfg", "ipxe-boot.cfg"],
  ["iPXE modules (mboot)", "Moduli iPXE (mboot)"],
  [
    "iPXE preload order — same list for UEFI and Legacy.",
    "Ordine di precaricamento iPXE — stessa lista per UEFI e Legacy.",
  ],
  [
    "Parameters passed to the kernel at boot",
...
const PAIRS_PT = [
  ...
  [
    "iPXE preload order — same list for UEFI and Legacy.",
    "Ordem de pré-carregamento iPXE — mesma lista para UEFI e Legacy.",
  ],
  [
    "Parameters passed to the kernel at boot",
