...
echo Fin diskpart — attente reseau avant SMB...
net start workstation >nul 2>&1
set "_NET_WAIT=0"
:wait_ping
set /a _NET_WAIT+=1
ping -n 1 -w 1000 {host} >nul
if not errorlevel 1 goto wait_ping_done
if !_NET_WAIT! lss 20 (
  timeout /t 2 /nobreak >nul
  goto wait_ping
)
echo Attention : le serveur {host} ne repond pas encore au ping.
:wait_ping_done
...
echo Tentative !_SMB_TRY!/8 echouee (erreur %errorlevel%).
if !_SMB_TRY! lss 8 (
  timeout /t 3 /nobreak >nul
